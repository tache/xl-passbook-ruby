...
module XLPassbook
  class PassesController < ApplicationController
    def get_pass
      pass = XLPassbook.pass_type_id_to_class(params[:pass_type_id]).find_by_serial_number params[:serial_number]
    ...
    def get_pkpass pass=nil
      pass ||= XLPassbook.pass_type_id_to_class(params[:pass_type_id]).update_or_create params
      render :pkpass => pass
    end
